...
*   It is possible to very simply [turn a Gradio app into an MCP server](https://www.gradio.app/guides/building-mcp-server-with-gradio)! (more relevant from Sprint 2 onwards)
